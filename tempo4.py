...
def obter_clima():
    try:
        ...
        # Converte a resposta JSON corretamente com UTF-8
        data = response.json()

        # Exibe o JSON formatado corretamente com acentos
        print("\n===== Clima Atualizado =====")
        print(json.dumps(data, indent=4, ensure_ascii=False))  # Garante que acentos sejam exibidos corretamente
